...
class SignupViewController: UIViewController {
    ...
    func configureTF() {
        ...
        mailTextField.attributedPlaceholder = NSAttributedString(string: "example@oroshify.app", attributes: [NSAttributedString.Key.foregroundColor : #colorLiteral(red: 0.3019607843, green: 0.3019607843, blue: 0.3019607843, alpha: 1)])
